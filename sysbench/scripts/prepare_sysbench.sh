...
CREATE INDEX IF NOT EXISTS k_4 ON sbtest4(k);
CREATE INDEX IF NOT EXISTS k_5 ON sbtest5(k);
CREATE INDEX IF NOT EXISTS k_6 ON sbtest6(k);
CREATE INDEX IF NOT EXISTS k_7 ON sbtest7(k);
CREATE INDEX IF NOT EXISTS k_8 ON sbtest8(k);
EOF
